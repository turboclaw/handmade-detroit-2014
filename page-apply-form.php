    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class( "article article--full" ); ?>>
        ...
        <div class="article__body cf">
            ...
            <form action="/apply-processing.php" method="post" enctype="multipart/form-data" id="apply_form" class="grid form form--apply">
                ...
                <div class="form__control-group grid__cell--one-third grid__cell--handheld--one">
                ...
                <div class="form__control-group grid__cell--one-half grid__cell--handheld--one">
                ...
                <div class="form__control-group grid__cell--one">
                    ...
                    <div id="photo_uploads" class="grid">
                        <div class="grid__cell--one-third grid__cell--handheld--one"><input type="file" name="photos_0" id="photos_0" /></div>
                        <div class="grid__cell--one-third grid__cell--handheld--one"><input type="file" name="photos_1" id="photos_1" /></div>
                        <div class="grid__cell--one-third grid__cell--handheld--one"><input type="file" name="photos_2" id="photos_2" /></div>
                        <div class="grid__cell--one-third grid__cell--handheld--one"><input type="file" name="photos_3" id="photos_3" /></div>
                        <div class="grid__cell--one-third grid__cell--handheld--one"><input type="file" name="photos_4" id="photos_4" /></div>
                    </div>
                </div>
                <div class="form__control-group grid__cell--one-half grid__cell--handheld--one">
